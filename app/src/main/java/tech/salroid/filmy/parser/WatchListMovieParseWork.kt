...
class WatchListMovieParseWork(private val context: Context, private val result: String) {

    fun parse_watchlist(): List<WatchlistData> {

        val favouriteArray = ArrayList<WatchlistData>()
        var favouriteData: WatchlistData? = null
