...
public class ItemResult {
    ...
    public ItemResult(Cursor cursor) {
        ...
        this.id = cursor.getColumnIndex(FilmContract.MoviesEntry.MOVIE_ID);
        ...
        this.posterPath = cursor.getString(poster_index);
        this.releaseDate = cursor.getString(year_index);
    }
