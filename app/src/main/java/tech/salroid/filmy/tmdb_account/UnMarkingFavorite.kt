...
class UnMarkingFavorite {
    ...
    private fun parseOutput(response: JSONObject, session_id: String, media_id: Int) {
        ...
        try {
            ...
            if (account_id != null) {
                ...
                val query = "https://api.themoviedb.org/3/account/" + account_id + "/favorite?api_key=" +
    ...
    private fun unmarkFavFinal(query: String, media_id: Int) {
        ...
        val jsonObjectRequest = object : JsonObjectRequest(query, null,
                Response.Listener { response -> parseUnMarkedResponse(response) }, Response.ErrorListener { error -> Log.e("webi", "Volley Error: " + error.cause) }) {
